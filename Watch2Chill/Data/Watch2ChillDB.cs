    ...
    public class Watch2ChillDB :DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Videos>().HasData(
               new Videos { Id = 1, Nome = "The Godfather", Genero = "Crime, Drama", Ano = new DateTime(1972), Elenco = "Al Pacino, Marlon Brando, James Caan, Richard S. Castellano", Idioma = "Inglês", Realizador = "Francis Ford Coppola", N_temporadas = 0, N_episodios = 1 },
               new Videos { Id = 2, Nome = "The dark Knight", Genero = "Crime, Drama, Ação", Ano = new DateTime(2008), Elenco = "Christian Bale, Heath Ledger, Aaron Eckhart, Michael Caine", Idioma = "Inglês", Realizador = "Christopher Nolan", N_temporadas = 0, N_episodios = 1 },
               new Videos { Id = 3, Nome = "The Lord of the Rings", Genero = "Aventura, Fantasia, Drama", Ano = new DateTime(2001), Elenco = "Alan Howard, Noel Appleby, Sean Astin, Sala Baker", Idioma = "Inglês", Realizador = "Peter Jackson", N_temporadas = 0, N_episodios = 1 },
               new Videos { Id = 4, Nome = "Star Wars: Episode I", Genero = "Aventura, Ação, Fantasia", Ano = new DateTime(1977), Elenco = "Mark Hamill, Harrison Ford, Carrie Fisher, Peter Cushing", Idioma = "Inglês", Realizador = "George Lucas", N_temporadas = 0, N_episodios = 1 },
               new Videos { Id = 5, Nome = "Harry Potter", Genero = "Fantasia, Aventura, Família", Ano = new DateTime(2001), Elenco = "Daniel Radcliffe, Rupert Grint, Richard Harris", Idioma = "Inglês", Realizador = "Chris Columbus", N_temporadas = 0, N_episodios = 1 },
               new Videos { Id = 6, Nome = "Breaking Bad", Genero = "Drama, Crime, Thriller", Ano = new DateTime(2008/2015), Elenco = "Bryan Cranston, Anna Gunn, Aaron Paul, Dean Norris", Idioma = "Inglês", Realizador = "Vince Gilligan", N_temporadas = 5, N_episodios = 62 },
               new Videos { Id = 7, Nome = "Game of Thrones", Genero = "Aventura, Drama, Fantasia", Ano = new DateTime(2011/2019), Elenco = " Emilia Clarke, Peter Dinklage, Lena Headey, Peter Dinklage, Kit Harington", Idioma = "Inglês", Realizador = "D.B. Weiss, David Benioff", N_temporadas = 8, N_episodios = 73 },
               new Videos { Id = 8, Nome = "Rick and Morty", Genero = "Animação, Aventura, Comédia", Ano = new DateTime(2013/2021), Elenco = "Justin Roiland, Chris Parnell, Spencer Grammer, Sarah Chalke", Idioma = "Inglês", Realizador = "Dan Harmon, Justin Roiland", N_temporadas = 4, N_episodios = 41 },
               new Videos { Id = 9, Nome = "Solar Opposites", Genero = "Animação, Faroeste, Ficção Científica", Ano = new DateTime(2020/2021), Elenco = "Justin Roiland, Sean Giambrone, Thomas Middleditch", Idioma = "Inglês", Realizador = "Justin Roiland, Mike McMahan", N_temporadas = 2, N_episodios = 16 },
               new Videos { Id = 10, Nome = "Final Space", Genero = "Animação, Aventura, Comédia", Ano = new DateTime(2018/2021), Elenco = "Olan Rogers, Fred Armisen, David Tennant", Idioma = "Inglês", Realizador = "Olan Rogers", N_temporadas = 3, N_episodios = 30 }
            );
            ...
            modelBuilder.Entity<Temporadas>().HasData(
               ...
               new Temporadas { Num = 3, N_episódios = 73, Id_VideosFK = 7 },
