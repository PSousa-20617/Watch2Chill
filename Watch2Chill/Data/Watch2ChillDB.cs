    ...
    public class Watch2ChillDB :DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UtilizadoresVideos>().HasData(
               new UtilizadoresVideos { Id_Utilizadores = 2, IdVideos = 1 },
               new UtilizadoresVideos { Id_Utilizadores = 3, IdVideos = 2 },
               new UtilizadoresVideos { Id_Utilizadores = 4, IdVideos = 3 }
            );
            ...
            modelBuilder.Entity<Temporadas>().HasData(
               new Temporadas { NumTemps = 0, NumEps = 1, IdVideosFK = 1 },
               new Temporadas { NumTemps = 0, NumEps = 1, IdVideosFK = 2 },
               new Temporadas { NumTemps = 0, NumEps = 1, IdVideosFK = 3 },
               new Temporadas { NumTemps = 0, NumEps = 1, IdVideosFK = 4 },
               new Temporadas { NumTemps = 0, NumEps = 1, IdVideosFK = 5 },
               new Temporadas { NumTemps = 5, NumEps = 62, IdVideosFK = 6, DataFim = "2015" },
               new Temporadas { NumTemps = 3, NumEps = 73, IdVideosFK = 7, DataFim = "2019" },
               new Temporadas { NumTemps = 4, NumEps = 41, IdVideosFK = 8, DataFim = "Ainda a decorrer" },
               new Temporadas { NumTemps = 2, NumEps = 16, IdVideosFK = 9, DataFim = "Ainda a decorrer" },
               new Temporadas { NumTemps = 3, NumEps = 30, IdVideosFK = 10, DataFim = "Ainda a decorrer" }
            );
